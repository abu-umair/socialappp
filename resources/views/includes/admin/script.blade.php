          ...
          $.ajax({
              ...
              success: function(data){
                  ...
                  for(let i=0; i<data.length;i++){
                      if (data[i].merchants_id != null) {
                            var routes ="{{route('home')}}"+"/admin/user-profile/"+data[i].id;
                            // <a href="#" class="list-group-item list-group-item-action disabled" id="list-me"><small> Dapibus ac facilisis in</small></a>
                            if (nodoct == 0) {
                              searchResultAjax +='<a class="list-group-item list-group-item-action disabled" id="list-me"><small> Merchant</small></a>'
                    ...
                    //   }
                            ...
                            var routes ="{{route('home')}}"+"/admin/user-profile/"+data[i].customers_id;
                            if (nocust == 0) {
