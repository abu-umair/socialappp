                ...
                <table id="mytable" class="table table-striped" style="width:100%">
                  ...
                  <tbody class="">
                    ...
                    <tr class="text-capitalize">
                        ...
                        <td>{{ $item->name }}</td>
                        <td>
                          <a href="{{ route('image_food', $item->id)}}">
                        ...
                        <td>{!! $item->category ? $item->category->category : '<div class="badge badge-danger"><span class="small">Category Removed</span></div>' !!}</td>
                        <td>{{ $item->price }}</td>
                        {{-- <td>{{ $item->promo }}</td> --}}
                        <td>
                          <a href="#">
                        ...
                        <td>
                          {{-- <a href="" 
                              ...
                              <form action="{{ route('foods.destroy', $item->id) }}"
                              ...
                              <form action="{{ route('foods_adfood_delete', $item->id) }}"
