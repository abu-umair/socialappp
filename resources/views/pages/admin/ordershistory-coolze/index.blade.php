...
@section('content')
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Home History Orders</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
                ...
                <table class="table table-bordered" id="example" width="100%" collspacing="0">
                  <thead>
                    <tr>
                      ...
                      <th><i class="fas fa-store d-block"></i> Nilai</th>
                            ...
                            <td><span class="badge badge-pill badge-light">{{$s++}}</span></td>
                              ...
                              <td width="13%">
                                @if ($item->status == 'accept')
                                  <a href="{{ route('history-orders.edit', $item->id)}}" 
                                ...
                                @elseif(Auth::user()->roles == 'PARTNER')
                                  {{-- @if ($item->status == 'accept')
                                  <a href="{{ route('history-orders_withId.edit', $item->id)}}" 
                                    class="btn btn-success">
                                    <i class="fas fa-star-half-alt"></i>
                                  </a>   
                                  @endif --}}
