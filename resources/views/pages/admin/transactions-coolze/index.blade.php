                ...
                <table class="table table-bordered " id="example" width="100%" collspacing="0">
                  <thead>
                      <tr>
                        ...
                        <th><i class="fas fa-pager d-block"></i>No Order</th>
                      ...
                      @forelse ($items as $item)                      
                          <tr>
                            <td><span class="badge badge-pill badge-light">{{$s++}}</span></td>
                              ...
                              <td><span class="badge badge-success">{{ $item->id_unique }}
                              ...
                              @if ($item->voucher)
                                @if ($item->voucher->status == 1)
                                  <td><img src="{!!$item->voucher->foto ? Storage::url($item->voucher->foto) : url('backend/assets/images/news/voucher.png') !!}" class="img-circle mr-1" width="35">{{ $item->voucher->name }}</td>
                                @else
                              ...
                              <td>
                                ...
                                <a href="{{route('invoice',$item->id)}}" class="btn btn-icon icon-left btn-info"><i class="fas fa-print"></i> Invoice</a>
                                @else
                                <a href="{{route('invoice_withPartner',$item->id)}}" class="btn btn-icon icon-left btn-info"><i class="fas fa-print"></i> Invoice</a>    
                                @endif
