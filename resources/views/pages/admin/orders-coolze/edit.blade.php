                  ...
                  @endif
                      ...
                      <form action="{{ route('orders.update', $item->id) }}" method="POST" >
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select name="customers_id" class="form-control">
                              <option value="{{$item->customers_id}}">{{$item->user_customer->name}}</option>
                              @foreach ($items_customers as $item_customer)
                              @if ($item_customer->id != $item->customers_id)
                        ...
                        {{-- <div class="form-group">
                          ...
                          <select name="customers_id" class="form-control" >
                              <option value="{{$item->customers_id}}">Jangan Diubah ( {{$item->user_customer->name}} )</option>
                              @foreach ($items_customers as $item_customer)
                                <option value="{{$item_customer->id}}">{{$item_customer->name}}</option>
                              @endforeach
                          </select>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select name="partners_id" class="form-control" id="sub_driver_name" >
                              <option value="{{$item->partners_id}}">{{$item->user_partner->name}}</option>
                              @foreach ($items_partners as $item_partners)
                              @if ($item_partners->id != $item->partners_id)
                        ...
                        {{-- <div class="form-group">
                          ...
                          <select name="partners_id" class="form-control" id="sub_driver_name" >
                              <option value="{{$item->partners_id}}">Jangan Diubah ( {{$item->user_partner->name}})</option>
                              @foreach ($items_partners as $item_partners)
                              <option value="{{$item_partners->id}}">{{$item_partners->name}}</option>
                              @endforeach
                          </select>
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select class="form-control formselect" name="drivers_id" placeholder="Select Driver" id="sub_driver">
                              <option value="{{$item->drivers_id}}" selected> {{$item->driver->name}}</option>
                          </select>
                            </select>
                          </div>
                        </div>
                        {{-- <div class="form-group">
                          ...
                          <select class="form-control formselect required" name="drivers_id" placeholder="Select Driver" id="sub_driver">
                            <option value="{{$item->drivers_id}}" selected>Jangan Diubah ( {{$item->driver->name}} )</option>
                          </select>
                        </div> --}}
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select name="vouchers_id" class="form-control">
                              <option value="{{$item->vouchers_id}}">{{$item->voucher->name}}</option>
                              @foreach ($items_vouchers as $item_vouchers)
                              @if ($item_vouchers->id != $item->vouchers_id)
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select name="packages_id" class="form-control" id="subpackages_name">
                              <option value="{{$item->packages_id}}">{{$item->package->title}}</option>
                              @foreach ($items_packages as $item_packages)
                              @if ($item_packages->id != $item->packages_id)
                        ...
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <select class="form-control formselect" name="subpackages_id" placeholder="Select Subpackage" id="subpackages" required>
                              <option value="{{$item->subpackages_id}}" selected>{{$item->subpackage->deskripsi_title}}</option>
                            </select>
                          </div>
                        </div>
                        {{-- <div class="form-group">
                          ...
                          <select class="form-control formselect required" name="subpackages_id" placeholder="Select Subpackage" id="subpackages">
                            <option value="{{$item->subpackages_id}}" selected>Jangan Diuabah ( {{$item->subpackage->deskripsi_title}} )</option>
                          </select>
                        </div> --}}
                        <div class="form-group">
                          ...
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="merk" placeholder="Merk" value="{{ $item->merk  }}" required>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                              <div class="col">
                                <div class="input-group">
                                  ...
                                  <input placeholder="Start Date" type="text" class="form-control datepicker" name="date" value="{{$item->date}}">
                                </div>
                              </div>
                              ...
                              <div class="col">
                                <div class="input-group">
                                  <input placeholder="End Date" type="text" class="form-control datepicker" name="end_date" value="{{ $item->end_date }}">
                                  <div class="input-group-prepend">
                                    <span class="input-group-text bg-gradient-light">
                          ...
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <input type="time" class="form-control" name="time" placeholder="Name" value="{{ $item->time }}" >               
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <select name="status" class="form-control" required>
                                <option class="text-capitalize" value="{{$item->status}}">{{$item->status}}</option>
                          ...
                          {{-- <div class="form-group">
                            ...
                            <div class="input-group">
                              ...
                              <select name="acc" class="form-control" required>
                                <option value="{{$item->acc}}">{{$item->acc == 0 ? 'No Acc' : 'Acc'}}</option>
                                @if ($item->acc == 0)
                      ...
                      <form action="{{ route('orders_withId.update', $item->id) }}" method="POST" >
                        @csrf{{-- setiap buat form pakai @csrf --}}
                        @method('PUT')
