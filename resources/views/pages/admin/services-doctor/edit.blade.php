  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Edit Doctors</div>
      </div>
    </div>
    ...
    <div class="section-body">
      ...
      <div class="card">
        ...
        @endif
            ...
            <div class="card-body">
                <form action="{{ route('services-doctor.update', $item->id) }}" method="POST" enctype="multipart/form-data">{{-- untuk menyimpan sebuah data menggunakan functioan 'store' --}}
                    ...
                    {{-- <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="layanan" placeholder="Kategori" value="{{ $item->service->title }}">
                    </div> --}}
