      ...
      <div class="section-body">
        <div class="card">
          <div class="card-header d-sm-flex align-items-center justify-content-between">
            <h4>Promotions</h4>
            <a href="{{ route('orivouchers-adfood.create')}}"
                ...
                <table id="mytable" class="table table-striped" style="width:100%">
                  ...
                  <tbody class="">
                    ...
                    <tr class="text-capitalize">
                        ...
                        <td>
                          <a href="#">
                             <img alt="image" src="{!!$item->foto ? Storage::url($item->foto) : url('backend/assets/img/avatar/orivoucher.png') !!}" class="rounded-circle" width="35" data-toggle="title" title="">
                          </a>
                        ...
                        <td>{{\Carbon\Carbon::parse($item->start_date)->format('d F y')}} - {{\Carbon\Carbon::parse($item->end_date)->format('d F y')}}</td>
                        ...
                        <td>
                          {{-- <a href="" 
                                ...
                                <a href="{{ route('orivouchers-adfood.edit', $item->id)}}" 
                                  class="btn btn-info">
                              ...
                              <form action="{{ route('orivouchers-adfood.destroy', $item->id) }}"
                              ...
                              <form action="{{ route('orivouchers-adfood-delete', $item->id) }}"
                              ...
                              {{-- <form action="{{ route('orivouchers-adfood_delete')}}"
