...
@section('title','Reservations Create')
@push('prepend-style')
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <form action="{{ route('reservations.store') }}" method="POST" enctype="multipart/form-data">
              ...
              {{-- <input type="hidden" name="order_id" value="625e7b22300ef"> --}}
              ...
              <div class="form-group">
                ...
                <input type="number" name="jumlah_orang" value="{{ old('jumlah_orang') }}" class="form-control" required>
              </div>
              <div class="form-group">
                <label>Date</label>
              ...
              <div class="form-group">
                ...
                <input type="datetime-local" name="tracking_register" value="{{ old('tracking_register') }}" class="form-control">
              </div>
              <div class="form-group">
                <label>Tracking Restaurant Check</label>
                <input type="datetime-local" name="tracking_restaurant_check" value="{{ old('tracking_restaurant_check') }}" class="form-control">
              </div>
              <div class="form-group">
                <label>Tracking Confrimed Restaurant</label>
                <input type="datetime-local" name="tracking_confrimed_restaurant" value="{{ old('tracking_confrimed_restaurant') }}" class="form-control">
              </div>
              <div class="form-group">
                <label>Tracking Done</label>
                <input type="datetime-local" name="tracking_done" value="{{ old('tracking_done') }}" class="form-control">
              </div>
              <div class="form-group">
                <label>Status</label>
