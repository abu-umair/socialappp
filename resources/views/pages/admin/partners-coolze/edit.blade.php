            ...
            <div class="card-body">
              <div class="row">
                <div class="table-responsive">
                  ...
                  @endif
                  <form action="{{ route('partners.update', $item->id) }}" method="POST" enctype="multipart/form-data">{{-- untuk menyimpan sebuah data menggunakan functioan 'store' --}}
                      ...
                      <input type="hidden" name="roles" value="PARTNER">
