    ...
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a >Ongoings</a></div>
    ...
    <div class="section-body">
      ...
      <div class="card">
        <div class="card-header d-sm-flex align-items-center justify-content-between ">
          <h1 class="h3 mb-0 text-gray-800">Ongoings</h1>
                      ...
                      @forelse ($items as $item)                      
                          <tr>
                              ...
                              <td>
                                ...
                                <a href="{{route('users-customer.profile',$item->customer->id)}}" class="font-weight-600"><img src="{!!$item->customer->foto ? Storage::url($item->customer->foto) : url('backend/assets/img/avatar/avatar-1.png') !!}" alt="avatar" class="img-thumbnail mr-1" width="35">{{ $item->customer == true ? $item->user->name : 'Telah Dihapus' }}</a>  
                                </td>                              
                              <td>
                              ...
                              <td>
                                ...
                                {{-- <button type="button" class="btn btn-icon btn-warning" data-toggle="modal" data-target="#exampleModal" data-whatever="{{$item->id}}"><i class="fas fa-info-circle "></i></button> --}}
