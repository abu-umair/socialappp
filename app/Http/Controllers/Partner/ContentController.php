...
class ContentController extends Controller
{
    ...
    public function index()
    {
        ...
        if(\Request::segment(1) == 'api') {
            return response()->json([
                'success' => true,
                'message' => 'List Semua Content',
                'data' => $items
                ], 200);
        }

        return view('pages.admin.content-coolze.index', [
            'items' => $items
        ]);
    }
    ...
    {
        return view('pages.admin.content-coolze.create');
    }
    ...
    public function store(ContentRequest $request)
    {
        ...
        if(\Request::segment(1) == 'api') {
            return response([
                'status' => 'OK',
                'message' => 'Berhasil Disimpan Content',
                'data' => $item
            ], 200);           
        }
        Alert::success('Content Ditambahkan', $item->title.' berhasil ditambahkan');        
    ...
    public function show($id)
    {
        ...
        if(\Request::segment(1) == 'api') {
            return response()->json([
                'success' => true,
                'message' => 'Get Content '.$item->title,
                'data' => $item
                ], 200);
        }
    ...
    public function edit($id)
    {
        ...
        return view('pages.admin.content-coolze.edit', [
            'item' => $item
        ]);
    }
    ...
    public function update(ContentRequest $request, $id)
    {
        ...
        Alert::success('Content Diupdate', $item->title.' berhasil diupdate');           
        return redirect()->route('content.index');
    }
    ...
    public function destroy($id)
    {
        ...
        Alert::success('Content Dihapus', $item->title.' berhasil dihapus');        
        return redirect()->route('content.index');
    }
