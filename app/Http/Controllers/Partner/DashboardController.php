...
class DashboardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // khusus menampilkan driver yang dimana utk ditampilkan where partner id yg login
        $onlyDriver = [];
        foreach ($item_users as $driver) {
            if ($driver->driver) {
                if ($driver->driver->partners_id == $this->user->id) {
                    $onlyDriver[] = $driver->driver->partners_id ;
                }
            }
        }
