...
class Customer_adfoodController extends Controller
{
    ...
    public function store(CustomerRequest $request)
    {
        ...
        if(\Request::segment(1) == 'api') {
            ...
            return response()->json([
                'data'          => new CustomerResource($item_new)
            ], 200);
    ...
    public function destroy($id)
    {
        ...
        if(\Request::segment(1) == 'api') {
            return response()->json([
                'data'          => new CustomerResource($item)
            ], 200);
            // return response()->json([
            //     'id'                => $item->id,
            //     'foto'              => $item->foto,
    ...
    public function destroy_permanen($id)
    {
        ...
        $services = Service::where('users_id',$item->id)->get();
        ...
        $jobs     = Job::where('users_id',$item->id)->delete();
